...
<form action="{{ route('libary.update', $libarys->id) }}" method="post">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="file" class="form-control" id="exampleInputPassword1" placeholder="" name="image" value="{{ $libarys->image }}">
    </div>
